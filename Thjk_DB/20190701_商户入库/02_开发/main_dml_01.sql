...
-- 1、创建 dim_merchant_info 表
-- 2、创建 dim_merchant_info_history 表
-- 3、将 dim_merchant_info_20190122 表中的全部数据插入到 dim_merchant_info 表的 20150101 日分区

-- hive --hivevar THE_DATE=20180502 -f main_dml_01.sql
