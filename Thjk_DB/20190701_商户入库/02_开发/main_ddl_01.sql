...
--  删除、重建 dim.tmp_dim_merchant_info 表

-- |                                                                                   |
-- =====================================================================================


-- SET hivevar:THE_TABLE=dim.dim_merchant_info;
-- SET hivevar:THE_TABLE=dim.tmp_dim_merchant_info;
...
PARTITIONED BY ( corp_id INT COMMENT '厂家编号')    -- 10001 通联，10002 收银宝
