...
class LoadExcel:
    ...
    def load_excel(self, p_file_name1: str, p_title_row: int, p_total_col: int, p_sql: str, p_sql2: str, p_data_type: list, the_date):
        # 连接数据库
        # p_title_row = 3 表示第4行是表头。
        # p_title_row = 0 表示第1行是表头。
        # p_title_row = -1 表示无表头。
