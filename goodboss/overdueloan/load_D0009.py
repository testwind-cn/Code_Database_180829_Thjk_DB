...
def load_excel_D0009(p_date, p_f_name='D0009LoanSurplusRpt_1.xls'):  # : str = u'D0009LoanSurplusRpt_1_修改.xls'
    ...
    a = LoadExcel()
    a.load_excel(p_file_name1=file_name1, p_title_row=3, p_total_col=62, p_sql=s_sql, p_sql2=s_sql2, p_data_type=data_type_D0009, the_date=p_date)
